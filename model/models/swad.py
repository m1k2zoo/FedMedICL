# Based on https://github.com/khanrc/swad
...
@torch.no_grad()
def update_bn(loader, model, n_steps, device):
    ...
    Args:
        ...
        device (torch.device, optional): data will be transferred to
    ...
    for i in range(n_steps):
        inputs, labels, attributes = loader.get_samples()
